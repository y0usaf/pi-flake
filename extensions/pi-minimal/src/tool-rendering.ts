...
export function patchToolExecutionComponent(): boolean {
	try {
		...
		proto.render = function piMinimalToolRender(this: any, width: number) {
			if (!state.features.tools || getToolExpanded(this)) return originalRender.call(this, width);
			return renderCompactToolLine(this, width);
		};

		proto.setExpanded = function piMinimalToolSetExpanded(this: any, expanded: boolean) {
