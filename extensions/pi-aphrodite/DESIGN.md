...
- The extension owns its own SQLite store state, availability, counters, and lifecycle; it does not mutate host state. Context handling returns replacement messages rather than editing Pi's message array.
