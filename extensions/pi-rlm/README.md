...
- REPL tool rows remain standard Pi tool executions, but recursive helper calls are also captured in structured details and rendered as a compact neo-tree-style recursion outline when present.
