...
export class ToolCallCellComponent implements Component {
	...
	render(width: number): string[] {
		...
		const line = truncateToWidth(parts.join(opts.theme.fg("dim", " · ")), width, "");
...
/** Result slot: output lines below the call line. Collapsed (or empty)
 * renders nothing — the call line carries the summary. */
